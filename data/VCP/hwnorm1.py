...
class HWnorm1rec(object):
 ...
 def __init__(self,line):
  ...
  for part in parts:
   ...
   self.dictstrs.append(s) # s is a comma-delimited list of dictionaries
   ndicts = ndicts + len(s.split(','))
  self.ndicts = ndicts
...
def init_hwnorm1(filein=None):
 if filein == None:
  # use hwnorm1c.txt in same directory as this hwnorm1.py module
  import os
