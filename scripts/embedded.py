...
if __name__=="__main__":
	...
	upasargacombinations += ['antar','punar','saha','acCa','sama','acCA','ku','aram','astam','aByastam','paScAt','prapalA','vipalA','saMpalA','pali','upapali','vipali','pla']
	...
	upasargasandhi = [('[iI]([aAuUfFxeEoO])','y\g<1>'),('[uU]([aAiIfFxeEoO])','v\g<1>'),('[aA][aA]','A'),('[iI][iI]','I'),('[uU][uU]','U'),('^nis([aAiIuUfFxeEoO])','nir\g<1>'),('(pr[aAiIuUfFxXeEoOhyvrkKgGNpPbBmM]*)n','\g<1>R'),('[aA][iI]','e'),('[aA][uU]','o'),('[aA][fF]','ar'),('[aA][x]','al'),('[aA][eE]','E'),('[aA][oO]','O'),('([iu])s([KPCWTcwtkpSzs])','\g<1>z\g<2>'),('([iu])z([KPCWTcwtkpSzs][Szs])','\g<1>H\g<2>'),('([iu])s([hyvrlJBGQDjbgqd])','\g<1>r\g<2>'),('prE','pre'),('sam([^aAiIuUfFxeEoO])','saM\g<1>'),('ud([KPCWTcwtkpSzs])','ut\g<1>'),('ut([cC])','uc\g<1>'),('ut([jJ])','uj\g<1>'),('utn','unn'),('u[td]m','unm'),('udl','ull'),('^antar([KPCWTcwtkpSzs])','antaH\g<1>'),('\(\?\)',''),('^Avisas$','Aviras'),('^prAdusas$','prAduras'),('^dus([^KPCWTcwtkpSzs])','dur\g<1>'),('^dus([^Szs])','duH\g<1>')]
